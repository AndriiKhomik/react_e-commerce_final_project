...
module.exports = productsData = [
  ...
  {
    name: "Death in the Spotlight",
    _id: "61b93928841df30652d5dba5",
    itemNo: rand(),
    imageUrls: ["https://res.cloudinary.com/dsdzwg97f/image/upload/v1639528526/books/41UqFPl2bPL._SX324_BO1_204_203_200__uu5gzn.jpg"],
    quantity: 0,
    author: "619a67d9c9a653c13ffbe3eb",
    categories: "ebooks",
    currentPrice: 10,
    publisher: "puffin",
    shortDescription: "Fresh from their adventure in Hong Kong, Hazel Wong and Daisy Wells are off to the Rue Theatre in London to face an entirely new challenge: acting",
    fullDescription: "<p>Fresh from their adventure in Hong Kong, Hazel Wong and Daisy Wells are off to the Rue Theatre in London to face an entirely new challenge: acting</p><p>But the Detective Society is never far away from danger, and it's clear there's trouble afoot at the Rue.Jealousy, threats and horrible pranks quickly spiral out of control - and then a body is found. Jealousy, threats and horrible pranks quickly spiral out of control - and then a body is found.</p>",
    yearOfPublishing: new Date("2018"),
    genre: "adventures",
    numberOfPages: 416
  },
  ...
  {
    name: "I Am a Warrior Goddess",
    imageUrls: ["https://res.cloudinary.com/dsdzwg97f/image/upload/v1639525941/books/JenniferAdams_qyuhjx.jpg"],
    _id: "61b92ed22d5ae78577b3a100",
    itemNo: rand(),
    quantity: 100,
    author: "6196a420d2ece067697ac9a5",
    categories: "paper-books",
    ...
    previousPrice: 35,
    publisher: "harper-Collins",
    shortDescription: "A warrior goddess is strong, powerful, and kind. She’s friends with the sun and the wind. She takes care of her body and mind. She helps others and makes the world a better place. Join a young girl with big aspirations and see how you can be a warrior goddess, too.",
    fullDescription: "<p>She isn’t a princess—she’s a warrior goddess!</p><p>You don’t have to be a grown-up to be a hero, and I Am a Warrior Goddess shows how in the empowering tale of a little girl with big aspirations.</p><p>Through the clever play between illustration and text, young readers learn how each day is full of opportunities to make a positive impact with ordinary actions. As our heroine connects with the earth, takes care of her body, and finds strength in kindness, she discovers her inner warrior goddess and inspires young girls everywhere to do the same.</p>",
    yearOfPublishing: new Date("2020"),
    numberOfPages: 32,
    genre: "children-literature",
    coverType: "hard",
  ...
  },
  {
    ...
    imageUrls: ["https://res.cloudinary.com/dsdzwg97f/image/upload/v1639526596/books/9781423625759_ojk90a.jpg"],
    _id: "61b931ac1ae10800dc6be0a4",
    itemNo: rand(),
    quantity: 100,
    author: "6196a420d2ece067697ac9a5",
    categories: "ebooks",
    ...
    fullDescription: "<p>Take a walk with the Ghosts of Christmas Past, Present, and Yet to Come in Little Master Dickens' A Christmas Carol: A BabyLit(R) Colors Primer. See old Jacob Marley shaking silver chains, gold stars shining around the Ghost of Christmas Past, and a red scarf keeping Tiny Tim warm. This bright retelling of a Christmas classic will scare any 'bah, humbug' feelings away.</p><p>JENNIFER ADAMS is the author of more than 30 books, including board books in the best-selling BabyLit series which introduce young children to the world of classic literature. Jennifer works as a writer and editor in Salt Lake City, Utah. Visit her website at jennifer-adams.com.</p>",
    yearOfPublishing: new Date("2012"),
    numberOfPages: 60,
    genre: "children-literature",
  },
  {
  ...
  {
    name: "Sisters of the Lost Marsh",
    imageUrls: ["https://res.cloudinary.com/dsdzwg97f/image/upload/v1639527529/books/51aa85JkLvL._SX331_BO1_204_203_200__jotpai.jpg"],
    _id: "61b93637778ce9041334284a",
    itemNo: rand(),
    quantity: 50,
    author: "6198cbc8d584625da10c9ee5",
    categories: "audio-books",
    ...
    shortDescription: "From the Waterstones Prize-shortlisted author of Our Castle by the Sea comes a gorgeously gothic story, perfect for fans of Emma Carroll and Frances Hardinge ...",
    fullDescription: "<p>Life is hard for Willa, Grace and Freya, and their three younger sisters. Six motherless girls working a farm, living in fear of their cruel father and the superstition that obsesses him - The Curse of Six Daughters.</p><p>With the arrival of the mysterious Full Moon Fayre, there's a chance for the eldest girls to steal a moment's fun, but the day the fayre moves on, Grace vanishes.</p><p>Willa goes after her, following a trail that leads into the dangerous Lost Marsh, where it is said a will-o'-the-wisp lures lost souls into the dark waters of the mire. If Willa is to survive and reunite her family, she will need to unravel the secrets her father has kept hidden, and face her own deepest fears ...</p>",
    yearOfPublishing: new Date("2021"),
    genre: "adventures",
    duration: 336
  },
