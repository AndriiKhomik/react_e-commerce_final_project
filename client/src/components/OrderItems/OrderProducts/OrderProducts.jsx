...
import {StyledSpan, SryledListItem, StyledSmallSpan, StyledBookNameSpan, StyledDivider, StyledBookCodeSpan} from './Styles'
import { StyledTitle, StyledBox, StyledSubtitleSpan, StyledYellowSpan } from '../Styles';
...
const OrderProducts = () => {
  ...
  <StyledDivider/>
  <List>
  {products.map(({id, img, name, price, quantity, itemNo})=><SryledListItem key={id}>
